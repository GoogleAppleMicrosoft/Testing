<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $mail->SMTPAuth = true;
        $mail->SMTPSecure = 'tls';
        $mail->Username = 'mrrathod000@gmail.com';
        $mail->Password = 'mrm@kE5mIn00';

        $mail->setFrom($_POST['email'],$_POST['name']);
        $mail->addAddress('mrmilan9.8@gmail.com');
        $mail->addReplyTo($_POST['email'],$_POST['name']);
        $mail->isHTML(true);
        $mail->Subject='Form Submission : '.$_POST['subject'];
        $mail->Body='
                    <h1 align=center>Name:'.$_POST['name'].'<br>Email: '
                    .$_POST['email'].'<br>Messsage:'.$_POST[msg].'</h1>';
        ...
        {
          $result = "Thanks".$_POST['name']." for contacting use";
        }
      }
      else
      {
